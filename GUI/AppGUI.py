...
# Form implementation generated from reading ui file 'd:\DeltaForceMarketBot\GUI\AppGUI.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_use.setGeometry(QtCore.QRect(240, 170, 221, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.textEdit_key_mode_buy_number = QtWidgets.QTextEdit(self.centralwidget)
        self.textEdit_key_mode_buy_number.setEnabled(False)
        self.textEdit_key_mode_buy_number.setGeometry(QtCore.QRect(90, 170, 121, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.textEdit_key_mode_buy_number.setFont(font)
        self.textEdit_key_mode_buy_number.setObjectName("textEdit_key_mode_buy_number")
        self.label_ideal_price_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_ideal_price_2.setGeometry(QtCore.QRect(20, 170, 71, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(11)
        font.setBold(True)
        font.setItalic(False)
        font.setWeight(75)
        self.label_ideal_price_2.setFont(font)
        self.label_ideal_price_2.setObjectName("label_ideal_price_2")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_ideal_price_2.setText(_translate("MainWindow", "购买数量"))
